...
class CreateTableCheckupNeuroExam extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(Schema::hasTable('checkup_neuro_exam') && !Schema::hasColumn('checkup_neuro_exam','2_3')) {
            /**
             * check to see if current table is the new neuro exam
             */
            ...
            Schema::create('checkup_neuro_exam', function (Blueprint $table) {
                ...
                $table->enum('funduscopy', ['ROR', 'Papilledema', 'Hemorrhages'])->nullable()->default(NULL);
                $table->enum('2_3', ['Isocoric', 'Anisocoric', 'Reactive', 'Unreactive'])->nullable()->default(NULL);
    ...
    {
        Schema::hasTable('checkup_neuro_exam')?Schema::drop('checkup_neuro_exam'):false;
    }
}
