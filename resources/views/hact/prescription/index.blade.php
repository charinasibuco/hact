		...
		<table class="responsive" width="100%">
			...
			<tbody>
				@foreach($patients as $row)
					<tr>
						<td>
							<a href="{{ route('prescription_history', $row->id) }}" title="Prescription History"><i class="fa fa-calendar fa-lg"></i></a>
							<a href="{{ route('prescription_create', $row->id) }}" title="Prescription"><i class="fa fa-plus fa-lg"></i></a>
						</td>
