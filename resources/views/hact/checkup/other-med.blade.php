<div id="otherMedModal" class="reveal-modal" data-reveal aria-labelledby="OtherTitle" aria-hidden="true" role="dialog">
    <form id="other_med_form" action="{{ route('checkup_store_session') }}" action="get">
        <input type="hidden" id="ses_key" name="key" value="" />
        <input type="hidden" name="med_type" value="others">
        <div class="row">
            <div class="large-12 columns">
                <h4 id="OtherTitle">Other Medicine</h4>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="large-4 columns">
                {!! csrf_field() !!}
                <button id="add_other" class="button small alert expand" type="submit">Add</button>
            </div>
        </div>
    </form>
