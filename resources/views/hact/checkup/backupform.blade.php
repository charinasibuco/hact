    ...
    <div class='row'>
        <div class='large-12 columns'>
            <ul class="breadcrumbs">
                ...
                <li><a href="{{ route('patient_profile', $patient_id) . "#tab2" }}">Checkup</a></li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="medium-3 columns">
                                            ...
                                            <input type="text" class="fdatepicker {{ ($errors->has('checkup_date')) ? 'highlight_error' : '' }}" id="checkup_date" name="checkup_date" placeholder="Check Up Date" value="{{ $checkup_date }}" readonly />
                                        </div>
