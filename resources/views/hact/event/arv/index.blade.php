	...
	<div class='row'>
		<div class='large-7 columns'>
			<ul class="breadcrumbs">
				...
				<li class="current"><a href="#">Antiretroviral (ARV)</a></li>
			</ul>
		</div>
	...
	<div class='row'>
		<div class='large-12 columns'>
			<table width="100%">
				...
				<tr>
					<td>
						<a href="{{ route('arv_show', $patient->id) }}" title="View ARV Profile"><i class="fa fa-user fa-lg"></i></a>
						<a href="{{ route('arv_create', $patient->id) }}" title="New ARV Record"><i class="fa fa-plus fa-lg"></i></a>
					</td>
