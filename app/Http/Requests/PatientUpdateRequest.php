...
class PatientUpdateRequest extends Request
{
    ...
    public function rules()
    {
         return [
            ...
            'email'                 => 'email|max:255|unique:patient,email,' . $this->id,

            'highest_educational_attainment' => 'required',

            'is_working'            => 'required',
            'current_occupation'    => 'required_if:is_working,1|max:255',
            'previous_occupation'   => 'max:255',

            'is_work_abroad_in_past_5years' => 'required',
            'last_contract'         => 'required_if:is_work_abroad_in_past_5years,1',
            ...
            'ui_code'               => 'unique:patient,ui_code,' . $this->id 
        ];
    }
