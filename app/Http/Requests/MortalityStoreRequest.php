...
class MortalityStoreRequest extends Request
{
    /**
    ...
    {
        return [
            "patient_id" => "required|unique:mortality,patient_id",
            "date_of_death" => "required|date",
            "is_hiv_related" => "required",
            "immediate_cause" => "required|max:255",
            "underlying_cause" => "max:255",
            "antecedent_cause" => "max:255",
            "immediate_icd10_code" => "max:255",
            "underlying_icd10_code" => "max:255",
            "antecedent_icd10_code" => "max:255",
            "other" => "required_if:other_check,1|max:255",
            "last_cd4_count" => "date",
            "cd4_count" => "numeric|max:255",
